...
| # | Date&nbsp;Added | Author | Title | Resource(s) | Nature | Level | Primary&nbsp;Contents | Secondary&nbsp;Contents | Language(s) | Programming Language(s) | Methods&nbsp;and/or&nbsp;Models | Notes
| ------------- | ------------- |------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------- |
